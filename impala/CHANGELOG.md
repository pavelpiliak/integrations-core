...
* Change the path to the default log folder ([#13001](https://github.com/DataDog/integrations-core/pull/13001))

## 1.0.0 / 2022-09-16

***Added***:

* Add the Impala integration ([#12548](https://github.com/DataDog/integrations-core/pull/12548))
